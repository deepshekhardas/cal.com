...
const buildHostLocation = (
  ...
  if (eventLocationType?.organizerInputType === "text") {
    if (eventLocationType.addressFieldName === "link") {
      location.link = inputValue;
    } else if (eventLocationType.addressFieldName === "address") {
...
const HostLocationRow = ({
  ...
  const currentLocationValue = useMemo(() => {
    ...
    if (currentLocationEventType.addressFieldName === "link") return currentLocation.link || "";
    if (currentLocationEventType.addressFieldName === "address") return currentLocation.address || "";
...
const useMassApplyMutation = (
  ...
  const handleMassApply = (locationType: string, inputValue?: string) => {
    ...
    const link = evtLocType?.addressFieldName === "link" ? inputValue : undefined;
    const address = evtLocType?.addressFieldName === "address" ? inputValue : undefined;
